...
class YXG_KCMBXG_Likelihood(GaussianLikelihood):
    ...
    def initialize(self):
        ...
        cov_kg = np.load(os.path.join(self.data_directory, self.cov_data_file)+f'{Mbin}_5_{Mbin}_5_dl.pk', allow_pickle=True)[f'bin_{Mbin}_5_{Mbin}_5']
        cov_yg = np.load(os.path.join(self.data_directory, self.cov_data_file)+f'{Mbin}_0_{Mbin}_0_dl.pk', allow_pickle=True)[f'bin_{Mbin}_0_{Mbin}_0']
        cov_cross = np.load(os.path.join(self.data_directory, self.cov_data_file)+f'{Mbin}_5_{Mbin}_0_dl.pk', allow_pickle=True)[f'bin_{Mbin}_5_{Mbin}_0']
        ...
        self.covmat =  np.block([[cov_kg, cov_cross],[cov_cross.T, cov_yg]])
