...
class YXG_CMBKXG_MISCENTER_Likelihood(GaussianLikelihood):
    params = { 'cmis': 0,}
    ...
    def get_requirements(self):
        return {"Cl_galnxtsz": {}, "cl_galn_lens": {}, "Cl_lensmagnxtsz": {}, "Cl_lensmagnxlens": {}}
    ...
    def _miscenter(self, Cl_orig, l_array, fmis, sigmaR_val, zbin_mean):
        ...
        # print("Cly_theta_interp: ", Cly_theta_interp )
        Cly_intpsi = (1. / (2 * np.pi)) * simps(Cly_theta_argnew, psi_array)
        # print("Cly_intpsi:", Cly_intpsi)
        ...
        # print("PRmis_mat", PRmis_mat)
        #Eq. 27
        # print("Rmis_array:", Rmis_array)
        Cly_intRmis = simps(Cly_intpsi * PRmis_mat, Rmis_array)
        # print("Cly_intRmis:", Cly_intRmis)
    ...
    def _get_theory(self, **params_values_dict):
        ...
        theory_km = self.provider.get_Cl_lensmagnxlens()
        for i in range(2):
            Nb=str(i)
            ...
            kg_1h_all.append(dl_kg_bin_1h), kg_2h_all.append(dl_kg_bin_2h), km_all.append(dl_km_bin),
        ...
        # print("diff mis:", (yg_1h_all[0] - yg_1h_cen_mis) /yg_1h_all[0])
        # print("1h cent : ", yg_1h_all[1])
